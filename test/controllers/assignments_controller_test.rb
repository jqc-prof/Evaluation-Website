...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference("Assignment.count") do
      post assignments_url, params: { assignment: { body: @assignment.body, title: @assignment.title, user_id: @assignment.user_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { body: @assignment.body, title: @assignment.title, user_id: @assignment.user_id } }
